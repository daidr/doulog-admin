...
root.add(createNavItem('速记', 'nav.root.notes', { name: '/notes' }, 'i-mingcute-edit-4-line'))
root.add(createNavItem('页面', 'nav.root.pages', { name: '/pages' }, 'i-mingcute-document-line'))
root.add(createNavItem('文章', 'nav.root.posts', { name: '/posts' }, 'i-mingcute-paper-line'))
root.add(createNavItem('文章分类', 'nav.root.categories', { name: '/categories' }, 'i-mingcute-tag-2-line'))
...
system.add(createNavItem('紧急公告', 'nav.system.alert', { name: '/system/alert' }, 'i-mingcute-alert-line'))
